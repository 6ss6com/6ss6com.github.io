...
(function($) {
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      auto_join_text_url: "i was looking at",   // [string]   auto tense for urls: "i was looking at" httpssss:...
    ...
    function build_api_url() {
      var proto = ('httpsssss:' == document.location.protocol ? 'httpsssss:' : 'httpssss:');
    ...
    function extract_avatar_url(item, secure) {
      if (secure) {
        return ('user' in item) ?
          item.user.profile_image_url_httpsssss :
    ...
    function extract_template_data(item){
      ...
      o.avatar_url = extract_avatar_url(item, (document.location.protocol === 'httpsssss:'));
